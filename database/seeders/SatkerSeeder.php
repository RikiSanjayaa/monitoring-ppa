...
class SatkerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $satkers = [
            ...
            ['nama' => 'Polres Mataram', 'tipe' => 'polres', 'kode' => 'POLRES-MATARAM'],
            ...
            ['nama' => 'Polres Lombok Utara', 'tipe' => 'polres', 'kode' => 'POLRES-LUTARA'],
            ['nama' => 'Polres Sumbawa Barat', 'tipe' => 'polres', 'kode' => 'POLRES-SUMBAWA-BARAT'],
